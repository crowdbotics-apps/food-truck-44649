"""
Django settings for food_truck_44649 project.
...
ROOT_URLCONF = 'food_truck_44649.urls'
...
WSGI_APPLICATION = 'food_truck_44649.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "food_truck_44649 API",
    "DESCRIPTION": "API documentation for food_truck_44649 App",
    "VERSION": "v1",
}
